...
export default class EmailService implements IEmailService {
   ...
   public async responseEmail(emails: string[], justification:string): Promise<ApiResponse<boolean | null>> {
        try {
                        ...
                        <div class="email-notification" style="width: 1440px; height: 1024px; background-color: #E2E2E2;">
                            ...
                            <div class="card" style="width: 600px; height: 443px; background-color: #ffffff; max-width: 600px; margin: 0 auto; top: 100px; left: 419px;">
                                ...
                                <div class="content" style="width: 599px; height: 317px; padding: 54px;">
                                    ...
                                    <p class="card-text" style="width: 471px; height: 57px; font-size: 17px; font-weight: 300; font-family: 'Rubik', sans-serif; line-height: 20.4px;">El responsable de la PQRSDF xxxxxxx en estado Cerrada está solicitando su reapertura por el siguiente motivo: ${justification} .</p>
